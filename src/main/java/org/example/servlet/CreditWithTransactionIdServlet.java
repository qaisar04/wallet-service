...
@Loggable
@WebServlet("/credit-with-id")
public class CreditWithTransactionIdServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (player.isPresent() && player.get().getUsername().equals(username) && username != null) {
                result = playerManager.creditWithTransactionId(
            ...
            if (result) {
                ...
                resp.getWriter().write("{\"message\": \"Credit transaction is successful\"}");
            } else {
                resp.setStatus(HttpServletResponse.SC_BAD_REQUEST);
                resp.getWriter().write("{\"error\": \"Credit transaction failed\"}");
            }
